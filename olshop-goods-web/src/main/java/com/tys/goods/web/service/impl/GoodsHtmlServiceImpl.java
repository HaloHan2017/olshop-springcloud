...
import com.tys.goods.web.utils.ThreadUtils;
...
public class GoodsHtmlServiceImpl implements GoodsHtmlService {
    @Value("storageHtmlPath")
    private String storageHtmlPath;
    ...
    public void createHtml(Long spuId) {
        ...
        //创建输出流
        File file = new File(storageHtmlPath + spuId + ".html");
        try {
    ...
    public void deleteHtml(Long id) {
        File file = new File(storageHtmlPath + id + ".html");
        file.deleteOnExit();
    }
}
