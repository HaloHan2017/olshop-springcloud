package com.tys.olshop.search.service.impl;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.tys.olshop.common.utils.JsonUtils;
import com.tys.olshop.common.utils.NumberUtils;
import com.tys.olshop.item.api.bo.SpuBo;
import com.tys.olshop.item.api.pojo.*;
import com.tys.olshop.search.bo.SearchRequest;
import com.tys.olshop.search.client.BrandClient;
import com.tys.olshop.search.client.CategoryClient;
import com.tys.olshop.search.client.GoodsClient;
import com.tys.olshop.search.client.SpecClient;
import com.tys.olshop.search.pojo.Goods;
import com.tys.olshop.search.repository.GoodsRepository;
...
public class SearchServiceImpl implements SearchService {
    ...
    private List<Map<String, Object>> getSpec(Long id, QueryBuilder basicQuery) {
        ...
        String specsJSONStr = specClient.querySpecificationByCategoryId(id).getBody();
        //1.将规格反序列化为集合
        List<Map<String, Object>> specs = null;
    ...
    private Map<String, Double> getNumberInterval(Long id, Set<String> keySet) {
        ...
        Map<String, Aggregation> aggregationMap = elasticsearchTemplate.query(queryBuilder.build(),
    ...
    private List<Category> getCategoryAggResult(Aggregation aggregation) {
        ...
        //根据id查询分类名称
        return categoryClient.queryCategoryByIds(cids).getBody();
    }
